...
module {
  ...
  // This migration continues the enhanced-migration chain so the new build is
  // recognized as using enhanced migration. main.mo is unchanged, so the stable
  // shape is identical to the preceding migration's NewActor: pure identity.
  // ─────────────────────────────────────────────────────────────────────────────
  type OldActor = {
