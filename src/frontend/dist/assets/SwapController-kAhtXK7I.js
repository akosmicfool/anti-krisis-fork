import { ad as NumberUtil, ae as withErrorBoundary, af as RouterController, ag as SnackController, ah as ConnectionController, ai as ConstantsUtil, aj as EventsController, ak as getPreferredAccountType, al as W3mFrameRpcConstants, am as ChainController, an as BlockchainApiController, ao as CoreHelperUtil, ap as SwapApiUtil, aq as AlertController, ar as BalanceUtil, as as ConstantsUtil$1, at as getActiveNetworkTokenAddress, au as ConnectorController, av as subscribeKey, aw as subscribe, ax as proxy } from "./index-D3Low12Q.js";
...
const controller = {
  ...
  async createSwapTransaction() {
    ...
    let amount = (_a = ConnectionController.parseUnits(sourceTokenAmount, sourceToken.decimals)) == null ? void 0 : _a.toString();
    try {
      ...
      if (isSourceTokenIsNetworkToken && amount) {
        const nativeToken = (_b = state.myTokensWithBalance) == null ? void 0 : _b.find((t) => t.address === networkAddress);
        if (nativeToken) {
