const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CUvN5p8t.js","assets/index-DqUaPUte.js","assets/index-kPqGAi2-.css"])))=>i.map(i=>d[i]);
import { aR as __vitePreload } from "./index-DqUaPUte.js";
const t = Symbol();
...
class d {
  ...
  async initUi() {
    if (typeof window < "u") {
      await __vitePreload(() => import("./index-CUvN5p8t.js"), true ? __vite__mapDeps([0,1,2]) : void 0);
