...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-C4L7cUbo.js";
import { u as ue } from "./index-lFSGe_yi.js";
import { u as useTestScore } from "./use-test-score-3ZFdOIZd.js";
import { P as Plus, T as TriangleAlert } from "./triangle-alert-CrGshVKr.js";
...
function CreditAbandonedMintsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "admin.credit_abandoned_mints.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Retroactively credit all abandoned mints to winners' internal balances. Use this after fixing a ledger configuration issue." })
    ] }),
...
function SupplyAuditSection() {
  ...
  const [recalcMsg, setRecalcMsg] = reactExports.useState(null);
  const formatAkk = (e8s) => e8s !== void 0 ? (Number(e8s) / 1e8).toLocaleString(void 0, {
  ...
  const handleRecalculate = async () => {
    try {
      ...
      setTimeout(() => setRecalcMsg(null), 5e3);
    } catch {
      setRecalcMsg("Recalculation failed.");
      setTimeout(() => setRecalcMsg(null), 5e3);
    }
  };
  const discrepancy = (audit == null ? void 0 : audit.discrepancy) ?? 0n;
  const hasDiscrepancy = discrepancy !== 0n;
  const tiles = [
    {
      label: "CURRENT SUPPLY",
      value: formatAkk(audit == null ? void 0 : audit.totalAkkMined),
      unit: "AKK"
    },
    {
      label: "ACTUAL BALANCES",
      value: formatAkk(audit == null ? void 0 : audit.sumOfAllBalances),
      unit: "AKK"
    },
    {
      label: "PENDING MINTS",
      value: formatAkk(audit == null ? void 0 : audit.pendingMints),
      unit: "AKK"
    },
    {
      label: "DISCREPANCY",
      value: audit ? formatAkk(discrepancy < 0n ? -discrepancy : discrepancy) : "—",
      unit: "AKK",
      highlight: hasDiscrepancy ? "red" : "green"
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "admin.supply_audit_section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-['VT323'] text-white text-xl tracking-widest uppercase", children: "SUPPLY AUDIT" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: isFetching ? "[LOADING…]" : "[REFRESH] →"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: tiles.map(({ label, value, unit, highlight }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `font-['VT323'] text-2xl ${highlight === "red" ? "text-red-400" : highlight === "green" ? "text-green-400" : "text-green-400"}`,
              children: value
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-['VT323'] text-green-700 text-xs tracking-widest", children: unit })
        ]
      },
      label
    )) }),
    hasDiscrepancy && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        className: "font-['VT323'] text-red-400 text-sm tracking-widest",
        "data-ocid": "admin.supply_audit_discrepancy_warning",
        children: "⚠ Discrepancy detected. Use RECALCULATE SUPPLY to reset Current Supply from block history."
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: recalculate.isPending ? "[RECALCULATING…]" : "[RECALCULATE SUPPLY]"
        }
      ),
      recalcMsg && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: `font-['VT323'] text-sm tracking-widest ${recalcMsg.includes("failed") ? "text-red-400" : "text-green-400"}`,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "tokens", "data-ocid": "admin.tabs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "testing", className: "mt-6 space-y-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-green-900/30 pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SupplyAuditSection, {}) }),
