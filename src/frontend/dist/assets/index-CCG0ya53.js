...
import { c as createStore, p as persist, a as createJSONStorage, v as l, B, _, h, b as clsx, y, T, d as createBundlerClient, e as createStore$1, s as set, f as del, g as get$1, i as slice$1, t as toHex$4, j as getSignPayload$2, k as sign$1, l as toHex$5, m as createKeyPair, n as fromHex$4, o as toSmartAccount, q as entryPoint06Address, r as entryPoint06Abi, u as getUserOperationHash } from "./index-BwZJ_MxZ.js";
import { fl as defineChain, ip as maxUint16, he as defineTransactionRequest, bV as hexToBytes, ey as toHex, hd as defineTransactionReceipt, b_ as hexToBigInt, c2 as hexToNumber$1, dY as formatLog, hc as defineTransaction, hb as defineBlock, ay as BaseError, ga as InvalidChainIdError$1, bK as isAddress, bL as InvalidAddressError, fk as serializeTransaction$1, bJ as concatHex, eq as toRlp, eo as toBytes$1, jy as sha256, bM as pad, kg as chainConfig$3, kh as chainConfig$4, c5 as AccountNotFoundError, bx as numberToHex$1, eV as assertRequest, eS as formatTransactionRequest$1, eR as extract, ki as getCallError, c0 as parseAccount, kj as formatters$1, kk as createCurve, kl as Field, e1 as sha256$1, e2 as sha384, e3 as sha512, km as fromHex, kn as toHex$1, ko as sha256$2, kp as fromString, kq as isEqual, kr as fromBytes, ks as fromString$1, kt as concat, ku as slice, kv as size, kw as fromHex$1, kx as assert$1, ky as toBigInt, kz as toNumber, kA as toString, kB as fromPublicKey, kC as verify$4, kD as isEqual$1, kE as from$4, kF as BaseError$1, kG as fromRpc$5, kH as stringify, kI as concat$1, kJ as toHex$2, kK as fromNumber, kL as toRpc$5, kM as recoverPublicKey, kN as assert$2, kO as checksum, kP as getSelector, kQ as fromHex$2, kR as keccak256, kS as assert$3, kT as extract$1, kU as fromRpcList$1, kV as yParityToV, kW as toRpcList$1, kX as random, kY as validate, kZ as trimLeft, k_ as from$5, k$ as recoverAddress, l0 as toTuple$2, l1 as toHex$3, l2 as validate$1, l3 as validate$2, l4 as fromTuple$2, hF as getTransactionType, l5 as fromHex$3, bW as encodeFunctionData, dP as readContract, jo as parseEventLogs, bZ as sendTransaction, f5 as writeContract, dZ as formatTransactionReceipt$1, hx as formatTransaction$1, l6 as from$6, bC as keccak256$1, dO as getCode, c6 as getAction, l7 as verifyHash, iD as maxUint256, ht as extendSchema, l8 as arbitrum, l9 as base$1, la as basePreconf, lb as celo, dh as mainnet, lc as optimism, ld as polygon, jJ as EventEmitter, d1 as createPublicClient, d2 as http, aJ as isHex, dc as hashTypedData, db as hashMessage, ep as slice$2, jB as stringToBytes, c3 as trim, h9 as decodeFunctionData, aH as encodeAbiParameters, bD as stringToHex, dN as size$1, hK as hexToString, eA as decodeAbiParameters, aC as isAddressEqual, bu as getAddress, h8 as decodeEventLog, dp as formatUnits, eO as parseUnits } from "./index-DqUaPUte.js";
import { w as waitForCallsStatus, d as parseSignature, b as encodePacked } from "./parseSignature-BNDUQgjW.js";
...
function assertEip712Transaction(transaction) {
  const { chainId, to, from: from2, paymaster, paymasterInput } = transaction;
...
function serializeTransactionEIP712(transaction) {
  const { chainId, gas, nonce: nonce2, to, from: from2, value, maxFeePerGas, maxPriorityFeePerGas, customSignature, factoryDeps, paymaster, paymasterInput, gasPerPubdata, data } = transaction;
...
function transactionToMessage(transaction) {
  const { gas, nonce: nonce2, to, from: from2, value, maxFeePerGas, maxPriorityFeePerGas, factoryDeps, paymaster, paymasterInput, gasPerPubdata, data } = transaction;
  return {
    txType: 113n,
    from: BigInt(from2),
    to: to ? BigInt(to) : 0n,
...
function verify$3(options) {
  ...
  return secp256r1.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex$1(publicKey).substring(2), { lowS: true, ...hash2 ? { prehash: true } : {} });
}
...
function serialize$3(envelope, options = {}) {
  ...
  if (type2 === "secp256k1") {
    ...
    return concat$1(toHex$2(secp256k1.signature), options.magic ? magicBytes : "0x");
  }
  if (type2 === "p256") {
...
function verify(signature, parameters) {
  ...
  if (envelope.type === "p256") {
    ...
    if (!isEqual$1(envelopeAddress, address))
      return false;
    return verify$3({
...
function from$1(authorization, options = {}) {
  ...
  const resolved = {
    ...
    ...auth.limits ? {
      limits: auth.limits.map((l2) => ({
        ...l2,
        token: resolve(l2.token)
      }))
    } : {},
    ...auth.scopes ? {
...
function hash$1(authorization) {
  ...
  const serialized = fromHex$2(authorizationTuple);
...
function deserialize(serialized) {
  ...
  if (validate$1(gas) && gas !== "0x")
    transaction.gas = BigInt(gas);
  if (validate$1(nonce2))
    transaction.nonce = nonce2 === "0x" ? 0n : BigInt(nonce2);
  if (validate$1(maxFeePerGas) && maxFeePerGas !== "0x")
    transaction.maxFeePerGas = BigInt(maxFeePerGas);
  if (validate$1(maxPriorityFeePerGas) && maxPriorityFeePerGas !== "0x")
    transaction.maxPriorityFeePerGas = BigInt(maxPriorityFeePerGas);
  if (validate$1(nonceKey))
    transaction.nonceKey = nonceKey === "0x" ? 0n : BigInt(nonceKey);
  if (validate$1(validBefore) && validBefore !== "0x")
    transaction.validBefore = Number(validBefore);
  if (validate$1(validAfter) && validAfter !== "0x")
    transaction.validAfter = Number(validAfter);
  if (validate$1(feeToken) && feeToken !== "0x")
  ...
  if (feePayerSignatureOrSender !== "0x" && feePayerSignatureOrSender !== void 0) {
    if (feePayerSignatureOrSender === "0x00" || validate$2(feePayerSignatureOrSender)) {
      ...
      if (validate$2(feePayerSignatureOrSender))
        transaction.from = feePayerSignatureOrSender;
    } else
      transaction.feePayerSignature = fromTuple$2(feePayerSignatureOrSender);
  }
  if (keyAuthorization)
...
function serialize$2(envelope, options = {}) {
  ...
  const serialized = [
    ...
    ...signature ? [serialize$3(from$3(signature))] : []
  ];
...
function getFeePayerSignPayload(envelope, options) {
  ...
  const serialized = serialize$2({ ...envelope, signature: void 0 }, {
    sender,
    format: "feePayer"
  });
  return keccak256(serialized);
...
async function serialize$1(transaction, signature) {
...
async function serializeTempo(transaction, sig) {
  ...
  if (signature && typeof transaction.feePayer === "object") {
    ...
    return serialize$2(tx, {
      feePayerSignature: from$5(feePayerSignature2)
    });
  }
  if (feePayer === true) {
    if (signature)
      return serialize$2(transaction_ox, {
        format: "feePayer",
...
async function signKeyAuthorization(account2, parameters) {
  const { chainId, key, expiry, limits, scopes } = parameters;
  const { accessKeyAddress, keyType: type2 } = resolveAccessKey(key);
  const signature = await account2.sign({
    hash: getSignPayload$1({
...
async function getMetadata(client, parameters) {
  ...
  const result = await readContract(client, {
    ...rest,
    ...getMetadata.call({ account: account2.address, accessKey })
  });
  return {
...
(function(getMetadata2) {
  function call(args) {
    const { account: account2, accessKey } = args;
    return defineCall({
      address: accountKeychain,
      abi: accountKeychain$1,
      functionName: "getKey",
      args: [account2, resolveAccessKeyAddress(accessKey)]
    });
  }
...
async function getRemainingLimit(client, parameters) {
  ...
  if (hardfork && lt(hardfork, "t3")) {
    const remaining2 = await readContract(client, {
      ...rest,
      ...getRemainingLimit.call({ account: account2.address, accessKey, token })
    });
...
(function(getRemainingLimit2) {
  function call(args) {
    const { account: account2, accessKey, token } = args;
    return defineCall({
      address: accountKeychain,
      abi: accountKeychain$1,
      functionName: "getRemainingLimit",
      args: [account2, resolveAccessKeyAddress(accessKey), token]
    });
  }
...
function formatTransaction(transaction) {
  ...
  const { feePayerSignature, gasPrice: _2, nonce: nonce2, ...tx } = fromRpc(transaction);
  return {
    ...tx,
...
function formatTransactionRequest(r, action) {
  ...
  const [keyType, keyData] = (() => {
    const type2 = account2 && "keyType" in account2 ? account2.keyType : account2 == null ? void 0 : account2.source;
    if (!type2)
  ...
  const keyId = account2 && "accessKeyAddress" in account2 ? account2.accessKeyAddress : void 0;
  if (account2)
    rpc.from = account2.address;
  return {
    ...rpc,
    ...keyData ? { keyData } : {},
    ...keyId ? { keyId } : {},
...
const chainConfig = {
  ...
  serializers: {
    ...
    transaction: (transaction, signature) => serialize$1(transaction, signature)
  },
...
const chains$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  abey,
  abstract,
  abstractTestnet,
...
function initDialog() {
  if (!dialog) {
    ...
    root2.className = "-base-acc-sdk-css-reset";
...
async function generateKeyPair() {
  ...
  const publicKey = slice$1(toHex$4(keypair.publicKey), 1);
...
async function getOrCreateKeypair() {
  ...
  if (!keypair) {
    ...
    const pubKey = slice$1(toHex$4(kp.publicKey), 1);
...
async function getAccount() {
  ...
  const sign2 = async (payload) => {
    const { payload: message, metadata } = getSignPayload$2({
      challenge: payload,
...
async function removeCryptoKey() {
  ...
  await storage.removeItem(slice$1(toHex$4(keypair.publicKey), 1));
...
async function presentSubAccountFundingDialog() {
  const dialog2 = initDialog();
  const userChoice = await new Promise((resolve2, reject) => {
...
function compute16ByteHash(input) {
  return slice$2(keccak256$1(toHex(input)), 0, 16);
}
...
function convertCredentialToJSON({ webauthn, signature, id }) {
  const signatureRaw = fromHex$4(signature);
  return {
    id,
...
function asn1EncodeSignature(r, s) {
  const rBytes = hexToBytes(trim(numberToHex$1(r)));
  const sBytes = hexToBytes(trim(numberToHex$1(s)));
...
function wrapSignature(parameters) {
  ...
  const signatureData = (() => {
    if (size$1(parameters.signature) !== 65)
  ...
  async _request(request) {
    ...
    switch (request.method) {
      ...
      case "eth_accounts": {
        ...
        (_c = this.callback) == null ? void 0 : _c.call(this, "connect", { chainId: numberToHex$1(this.chain.id) });
      ...
      case "eth_chainId":
        return numberToHex$1(this.chain.id);
      ...
      case "wallet_connect": {
        ...
        (_f = this.callback) == null ? void 0 : _f.call(this, "connect", { chainId: numberToHex$1(this.chain.id) });
        return result;
      }
      ...
      case "coinbase_fetchPermissions": {
        ...
        const requestedChainId = hexToNumber$1((_g = completeRequest.params) == null ? void 0 : _g[0].chainId);
...
function getPublicClientFromChainId(chainId) {
  const viemChain = Object.values(chains$1).find((chain) => chain.id === chainId);
  if (!viemChain) {
    return void 0;
  }
