import { dI as commonjsGlobal, dL as getDefaultExportFromCjs, r as reactExports, kc as clsx, D as React, kd as invariant, ke as useProtocolBurnSummary, j as jsxRuntimeExports, kf as useProtocolStats, L as Link, v as useActor, s as useQuery, w as createActor } from "./index-DqUaPUte.js";
...
function StatCard$1({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border p-3 sm:p-4 flex flex-col gap-1.5 sm:gap-2 min-w-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest font-mono text-white truncate", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-base sm:text-xl text-accent truncate", children: value })
  ] });
}
function CustomBarTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold mb-0.5", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: formatUSDValue(payload[0].value) })
      ]
    }
  );
}
function BurnSummaryTable({ summary, chartData }) {
  const [open, setOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 min-w-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl sm:text-2xl md:text-3xl text-white tracking-widest mb-2", children: "REGNET BURNS" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", style: { minHeight: 200 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      BarChart,
      {
        data: chartData,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            YAxis,
            {
              tickFormatter: (v2) => v2 >= 1e3 ? `$${(v2 / 1e3).toFixed(0)}k` : `$${v2.toFixed(0)}`,
              tick: {
                fill: "#8b9d8b",
                fontSize: 10,
                fontFamily: "monospace"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
              content: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomBarTooltip, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "[BURN SUMMARY]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "group-hover:translate-y-0.5 transition-transform duration-200", children: open ? "↑" : "↓" })
        ]
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full border border-border overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs min-w-[280px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-2 py-1 text-left font-display text-sm tracking-widest text-green-400 uppercase", children: "RegNet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-2 py-1 text-right font-display text-sm tracking-widest text-green-400 uppercase", children: "TOKENS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-2 py-1 text-right font-display text-sm tracking-widest text-green-400 uppercase", children: "$ Value" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-2 py-1 text-right font-display text-sm tracking-widest text-green-400 uppercase", children: "% of Total" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: (() => {
        ...
        return [...summary.byToken].sort((a2, b2) => b2[2] - a2[2]).map(([symbol, tokensBurned, usdValue]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "border-b border-border/40 last:border-0",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-2 py-0.5 font-['Tomorrow'] text-white text-xs tracking-wider", children: symbol }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-2 py-0.5 font-['Tomorrow'] text-white text-xs text-right", children: tokensBurned.toLocaleString("en-US", {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
              }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-2 py-0.5 font-['Tomorrow'] text-white text-xs text-right", children: formatUSDValue(usdValue) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-2 py-0.5 font-['Tomorrow'] text-white text-xs text-right", children: [
...
function BurnInfoSection() {
  const { data: summary, isLoading } = useProtocolBurnSummary();
  const chartData = (summary == null ? void 0 : summary.byToken) ? [...summary.byToken].sort((a2, b2) => b2[2] - a2[2]).map(([symbol, , usdValue]) => ({ symbol, usdValue })) : [];
  const hasData = chartData.length > 0 && ((summary == null ? void 0 : summary.totalBurnUsd) ?? 0) > 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2 sm:mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl text-white tracking-widest", children: "BURN INFO" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm sm:text-base text-foreground/85 leading-relaxed mb-6 sm:mb-8", children: [
          "Every burn is an",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "irreversible act of coordination" }),
          ". GRIT is earned for the sacrifice and spent for mining $AKK."
        ] }),
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row gap-4 sm:gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:w-1/3 flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:w-2/3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg text-muted-foreground tracking-widest", children: "No burns recorded yet." })
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 sm:gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row gap-2 sm:gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                label: "TOTAL GRIT",
                value: `${formatGrit$1(summary.totalGritFromBurns)}`
              }
            ) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(BurnSummaryTable, { summary, chartData })
        ] })
      ] })
    }
  );
...
function formatCountdown(seconds) {
  const s2 = Number(seconds);
  if (s2 <= 0) return "00:00";
  const m2 = Math.floor(s2 / 60);
  const sec = s2 % 60;
  return `${String(m2).padStart(2, "0")}:${String(sec).padStart(2, "0")}`;
}
function StatCard({
  label,
  value,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest font-mono text-white leading-tight truncate", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: [
...
function KeyInfoSection() {
  ...
  const [countdown, setCountdown] = reactExports.useState(0n);
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2 sm:mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl text-white tracking-widest", children: "PROTOCOL STATE" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm sm:text-base text-foreground/85 leading-relaxed mb-6 sm:mb-8 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2.5 h-2.5 rounded-full bg-green-400 shrink-0 animate-[blink_1.4s_ease-in-out_infinite]" }),
          "Live Action"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              label: "NEXT BLOCK",
              value: loading ? "—" : !stats.isMiningActive ? "Paused" : formatCountdown(countdown)
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
            {
              ...
              value: loading ? "—" : `${(Number(stats.totalAkkMined) / 1e8).toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} AKK`
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StatCard,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              label: "NEXT HALVING",
              value: loading ? "—" : `${Number(stats.blocksUntilHalving ?? 0n).toLocaleString("en-US")} blocks`
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 sm:mt-8 flex flex-wrap items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/mining/blocks",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "[Full History]" }),
...
function MiniStatTile({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border p-3 sm:p-4 flex flex-col gap-1.5 min-w-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest font-mono text-white leading-tight truncate", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-base sm:text-xl text-accent truncate", children: value })
  ] });
}
...
function useTotalAk69Score() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return 0;
      try {
        const v2 = await actor.getHistoryBasedAk69Stockpile();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-full max-w-4xl mx-auto space-y-6 text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm sm:text-base tracking-widest", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-normal", children: "Welcome to the " }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-bold", children: "Arena" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-normal", children: "." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "blockquote",
            {
              ...
              children: "“We see crises everywhere. It's not the players who are bad — it's the game itself.”"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-3 sm:gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-accent leading-none tracking-wider drop-shadow-[0_0_20px_rgba(0,255,65,0.5)]", children: "ANTI KRISIS" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mt-4 sm:mt-8 text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mr-2", children: "→" }),
                  "the",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "antithesis" }),
                  " to a world in ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "metacrisis" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  ...
                  "an",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "infinite game" }),
                  " to coordinate civilization toward a",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "flourishing future" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "multi-capital store of value" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 sm:pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/akore",
              className: "inline-flex items-center gap-2 border border-accent px-5 py-2.5 sm:px-6 sm:py-3 font-accent text-accent text-sm sm:text-base tracking-widest uppercase hover:bg-accent/10 transition-all duration-200 hover:shadow-[0_0_16px_rgba(0,255,65,0.3)]",
...
function InfiniteGameSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6 sm:mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl text-accent tracking-widest", children: "INFINITE GAME" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 sm:space-y-5 font-body text-sm sm:text-base md:text-lg text-foreground/85 leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-ocid": "overview.infinite_game_p1", children: [
            "The games we inherit are built to",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "extract, accumulate and collapse" }),
            " ",
            "— taking from the basis of life until there's nothing left."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-ocid": "overview.infinite_game_p2", children: [
            "Anti Krisis",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "redesigns the game" }),
            " ",
            "from the economic layer up, creating a foundation for civilisational coordination to",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "emerge in service of life" }),
            "."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 sm:mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "[What is Game B]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "group-hover:translate-x-1 transition-transform duration-200", children: "→" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(MiniStatTile, { label: "Games", value: "1" })
            ]
          }
        )
      ] })
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6 sm:mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl text-accent tracking-widest", children: "KAPITAL FUSION" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 sm:space-y-5 font-body text-sm sm:text-base md:text-lg text-foreground/85 leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-ocid": "overview.kapital_fusion_p1", children: [
            "Anti Krisis Protocol pioneers a multi-token",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "Proof of Burn" }),
            " ",
            "consensus mechanism to mine",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "Anti Krisis Koin ($AKK)" }),
            " ",
            "— the multi-capital SoV capped at",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "21 million." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-ocid": "overview.kapital_fusion_p2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "$AKK" }),
            " stores not just financial or manufactured capital, but also",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "natural, social and human" }),
            " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 sm:mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "[Read the Protocol]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "group-hover:translate-x-1 transition-transform duration-200", children: "→" })
            ]
          }
        ) })
...
function Ak69Section() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-3 sm:gap-4 mb-6 sm:mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl text-accent tracking-widest", children: "AK69" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "font-body text-sm sm:text-base text-foreground/70 italic tracking-wide",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-body text-sm sm:text-base md:text-lg text-foreground/90 leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-ocid": "overview.ak69_tagline.1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mr-2", children: "→" }),
            "soul-bound",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "meta score" }),
            " in the Anti Krisis arena"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-ocid": "overview.ak69_tagline.2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mr-2", children: "→" }),
            "symbol of",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "resistance, resilience and regeneration" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { "data-ocid": "overview.ak69_tagline.3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent mr-2", children: "→" }),
            "memetic",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-normal", children: "weapon of mass coordination" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          MiniStatTile,
          {
            label: "AK69 STOCKPILE",
            value: totalScore != null ? Math.round(totalScore).toLocaleString() : "—"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
...
function OverviewPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", "data-ocid": "overview.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InfiniteGameSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(KapitalFusionSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BurnInfoSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(KeyInfoSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ak69Section, {}),
