import{bj as k,dz as le,af as c,ah as pe,a1 as v,a2 as V,a5 as f,a6 as g,a7 as d,a4 as l,aW as $,aq as H,aX as u,a3 as me,am as w,a9 as B,aU as U,d8 as fe,bp as F,aj as K,bg as A,au as M,ac as we,ag as E,bl as z,d5 as oe,aV as be,ab as ce,dA as ge,dB as ye}from"./index-D01J8p_2.js";import{P as D}from"./index-DONmbcfA.js";import{S as ve}from"./SwapController-DXo0VOen.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
