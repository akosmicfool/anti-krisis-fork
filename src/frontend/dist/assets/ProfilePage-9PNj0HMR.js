...
async function compressTribePhoto$1(file) {
...
async function compressCoverImage$1(file) {
  return new Promise((resolve) => {
    const img = new Image();
    const url = URL.createObjectURL(file);
    img.onload = () => {
...
function CreateTribeModal({ onClose }) {
  ...
  async function handlePhoto(e) {
    ...
    if (file.size > 5 * 1024 * 1024) {
      ue.error("Image too large", { description: "Max 5MB allowed." });
      return;
    }
    const compressed = await compressTribePhoto$1(file);
  ...
  async function handleCoverImage(e) {
    ...
    const compressed = await compressCoverImage$1(file);
    setCoverImageUrl(compressed);
  }
  async function handleSubmit(e) {
    e.preventDefault();
    if (!name.trim()) {
      ue.error("Tribe name is required");
      return;
    }
    try {
      ...
      ue.success("Tribe created!", {
        description: `${name.trim()} is now live.`
      });
      onClose();
    } catch (err) {
      ue.error("Failed to create tribe", {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-accent tracking-widest uppercase", children: "Create Tribe" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-accent text-[10px] uppercase tracking-widest text-accent", children: "Cover Image" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    onClick: () => {
                      var _a2;
                      return (_a2 = coverFileRef.current) == null ? void 0 : _a2.click();
                    },
                    "aria-label": "Upload cover image",
                    children: coverImageUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                        src: coverImageUrl,
                        alt: "Cover",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-accent text-[9px] uppercase tracking-widest", children: "Upload Cover" })
                    ] })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "font-accent text-[10px] uppercase tracking-widest text-accent", children: "Tribe Photo" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-accent text-[9px] text-muted-foreground", children: [
                  name.length,
                  "/30"
                ] })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: createTribe.isPending ? "Creating…" : "Create Tribe"
                  }
                )
              ] })
            ] })
...
async function compressTribePhoto(file) {
  return new Promise((resolve) => {
    const img = new Image();
    const url = URL.createObjectURL(file);
    img.onload = () => {
...
function EditTribeModal({ tribe, onClose }) {
  const [name, setName] = reactExports.useState(tribe.name);
  const [description, setDescription] = reactExports.useState(tribe.description);
  const [photoUrl, setPhotoUrl] = reactExports.useState(
    tribe.photoUrl ?? null
  );
  const [coverImageUrl, setCoverImageUrl] = reactExports.useState(
    tribe.coverImageUrl ?? null
  );
  const fileRef = reactExports.useRef(null);
  const coverFileRef = reactExports.useRef(null);
  const editTribe = useEditTribe();
  ...
  async function handleSubmit(e) {
    ...
    const nameChanged = trimmedName !== tribe.name;
    try {
      const updatedTribe = await editTribe.mutateAsync({
        tribeId: tribe.id,
        name: nameChanged ? trimmedName : null,
        description: description.trim() !== tribe.description ? description.trim() : null,
        photoUrl: photoUrl !== (tribe.photoUrl ?? null) ? photoUrl : null,
        coverImageUrl: coverImageUrl !== (tribe.coverImageUrl ?? null) ? coverImageUrl : null
      });
      ue.success("Tribe updated!");
      if (nameChanged && updatedTribe && updatedTribe.id !== tribe.id) {
        const newId = updatedTribe.id;
        onClose(newId);
        navigate({ to: "/tribe/$tribeId", params: { tribeId: newId } });
      } else {
        onClose();
      }
    } catch (err) {
      ue.error("Failed to update tribe", {
        description: err instanceof Error ? err.message : "Unknown error"
      });
    }
  }
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-accent tracking-widest uppercase", children: "Edit Tribe" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  ...
                  className: "p-1 text-muted-foreground hover:text-accent transition-colors",
                  "aria-label": "Close",
                  "data-ocid": "edit-tribe.close_button",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" })
                }
              )
            ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    className: "hidden",
                    onChange: handleCoverImage,
                    "data-ocid": "edit-tribe.cover_upload_button"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    className: "hidden",
                    onChange: handlePhoto,
                    "data-ocid": "edit-tribe.photo_upload_button"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    maxLength: 30,
                    className: "bg-input border-border text-foreground font-mono text-sm focus:ring-accent focus:border-accent",
                    "data-ocid": "edit-tribe.name_input"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-accent text-[9px] text-muted-foreground", children: [
                  name.length,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Textarea,
                  {
                    ...
                    maxLength: 500,
                    className: "bg-input border-border text-foreground font-mono text-sm resize-none focus:ring-accent focus:border-accent",
                    "data-ocid": "edit-tribe.description_textarea"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-accent text-[9px] text-muted-foreground", children: [
                  description.length,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    onClick: () => onClose(),
                    className: "flex-1 font-accent text-[10px] uppercase tracking-widest border-border text-muted-foreground hover:text-foreground",
                    "data-ocid": "edit-tribe.cancel_button",
                    children: "Cancel"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    type: "submit",
                    disabled: editTribe.isPending || !name.trim(),
                    className: "flex-1 font-accent text-[10px] uppercase tracking-widest bg-primary hover:bg-primary/80 text-primary-foreground btn-glow",
                    "data-ocid": "edit-tribe.submit_button",
                    children: editTribe.isPending ? "Saving…" : "Save Changes"
                  }
                )
              ] })
            ] })
...
function TransferOwnershipModal({ tribe, onClose }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      ue.success("Ownership transferred!", {
        description: `${tribe.name} is now owned by @${username.trim()}.`
      });
      onClose();
    } catch (err) {
      const raw = err instanceof Error ? err.message : String(err);
      const description = raw === "newOwnerMaxTribes" ? "This player already owns the maximum of 5 tribes and cannot receive ownership." : raw === "newOwnerNotFound" || raw === "newOwnerNoUsername" ? "That username could not be found." : raw || "Unknown error";
      ue.error("Transfer failed", { description });
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-destructive tracking-widest uppercase", children: "Transfer Ownership" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-sm text-muted-foreground", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold", children: tribe.name }),
              " to another user. This action cannot be undone."
            ] }),
            confirmed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-3 border border-destructive/40 bg-destructive/10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 text-destructive flex-shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-sm text-destructive", children: [
                "Confirm: transfer ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: tribe.name }),
                " to",
                " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: transfer.isPending ? "Transferring…" : confirmed ? "Confirm Transfer" : "Transfer"
                  }
                )
              ] })
            ] })
...
const _Signature = class _Signature {
  ...
  getCanonical() {
    ...
    const v = 55 - this.v;
    const result = new _Signature(_guard$1, this.r, toUint256(s), v);
    if (this.networkV) {
   ...
   */
  clone() {
    const clone = new _Signature(_guard$1, this.r, this._s, this.v);
    if (this.networkV) {
  ...
  static from(sig) {
    ...
    if (typeof sig === "string") {
      ...
      if (bytes2.length === 65) {
        ...
        return new _Signature(_guard$1, r2, s2, v2);
      }
...
async function readBalanceOf(contractAddress, walletAddress) {
...
function useNftOwnership() {
  const { address: connectedAddress } = useConnection();
  const [holdsOgBadge, setHoldsOgBadge] = reactExports.useState(false);
  const [nftCheckLoading, setNftCheckLoading] = reactExports.useState(false);
  const [nftCheckError, setNftCheckError] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    async function checkOwnership() {
      ...
      try {
        ...
        let balB = 0n;
        try {
          balA = await readBalanceOf(NFT_CONTRACT_A, targetAddress);
        } catch (err) {
          console.error(
        ...
        try {
          balB = await readBalanceOf(NFT_CONTRACT_B, targetAddress);
        } catch (err) {
          console.error(
...
function FieldLabel({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-accent text-xs uppercase tracking-widest text-white", children });
}
...
function ProfilePage() {
  ...
  const [showCreateTribe, setShowCreateTribe] = reactExports.useState(false);
  const [editingTribe, setEditingTribe] = reactExports.useState(null);
  const [transferTribe, setTransferTribe] = reactExports.useState(null);
  const [leavingTribe, setLeavingTribe] = reactExports.useState(null);
  const [tribeSearch, setTribeSearch] = reactExports.useState("");
  const { data: tribeResults = [], isFetching: searchFetching } = useSearchTribes(tribeSearch);
  const claimBadge = useClaimOgBadge();
  const updatePlayerBadge = useUpdatePlayerBadge();
  const { holdsOgBadge } = useNftOwnership();
  const canClaimBadge = holdsOgBadge && !((profile == null ? void 0 : profile.hasOgBadge) ?? false);
  const handleClaimBadge = async () => {
    await claimBadge.mutateAsync();
  };
  reactExports.useEffect(() => {
    if (isAuthenticated && !updatePlayerBadge.isPending && !updatePlayerBadge.isSuccess) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const code = err && typeof err === "object" && "profileError" in err ? String(err.profileError) : "";
      const msg = err instanceof Error ? err.message : "Could not save profile";
      if (code === "usernameAlreadyTaken" || msg.toLowerCase().includes("already taken")) {
        setUsernameError("Username already taken");
      }
      ue.error("Save failed", { description: msg });
    }
  }
  async function handleShare() {
    ...
    if (success) {
      ...
      ue.success("Link copied!", { description: url });
    } else {
  ...
  if (isLoading || profileLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full bg-muted" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-48 bg-muted" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-64 bg-muted" })
        ]
      }
    );
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-8", "data-ocid": "profile.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-6", "data-ocid": "profile.identity_section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-14 border border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-32 sm:h-48 overflow-hidden bg-muted", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: coverSrc,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-10 sm:-bottom-12 left-4 sm:left-6 flex items-end gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-20 h-20 sm:w-24 sm:h-24 border border-border overflow-hidden bg-muted", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: avatarSrc,
            ...
            editMode && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "h-5 w-5 text-accent" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
          ...
          myTribe && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/tribe/$tribeId",
              ...
              children: myTribe.photoUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg text-accent", children: myTribe.name.charAt(0).toUpperCase() })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-2 right-3 flex items-center gap-2", children: editMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          form.username && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
              variant: "outline",
              ...
              children: shareCopied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-3.5 w-3.5 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Copied!" })
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      !editMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center gap-3", children: displayName && /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl text-foreground tracking-widest", children: displayName }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-4", children: [
          form.username && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-accent text-base text-accent tracking-widest", children: [
            "@",
            form.username
          ] }),
          form.location && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 font-mono text-sm text-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3.5 w-3.5 text-accent" }),
            form.location
          ] }),
          form.born && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 font-mono text-sm text-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "username", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { children: "Username *" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "username",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "displayName", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { children: "Display Name" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "displayName",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "location", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(FieldLabel, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "inline h-2.5 w-2.5 mr-0.5" }),
              " Location"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "born", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { children: "Born" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "born",
    ...
    (editMode || form.bio || form.socials.filter((l) => l.name && l.url).length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-6", children: [
          (editMode || form.bio) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { white: true, children: "Bio" }),
            editMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "bio", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { children: "About You" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Textarea,
                {
                  id: "bio",
          ...
          (editMode || form.socials.filter((l) => l.name && l.url).length > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex-1 min-w-0",
              "data-ocid": "profile.socials_section",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { white: true, children: "Links" }),
                editMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  form.socials.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      style: {
                        display: "flex",
                ...
                ] }) : form.socials.filter((l) => l.name && l.url).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: form.socials.map(
                      (link, i) => link.name && link.url ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "a",
                        {
                          href: link.url,
                          target: "_blank",
    ...
    principalText && /* @__PURE__ */ jsxRuntimeExports.jsx(
      HighlightsSection,
      {
        ...
        hasOgBadge: (profile == null ? void 0 : profile.hasOgBadge) ?? false,
        canClaimBadge,
        onClaimBadge: handleClaimBadge,
        playerBadgeLevel: testScore !== null ? testBadgeLevel : Number((profile == null ? void 0 : profile.playerBadgeLevel) ?? 0n)
      }
    ),
    (editMode || form.superpowers || interests) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        className: "border border-border p-4 bg-card mb-6",
        "data-ocid": "profile.superpowers_interests_section",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-6", children: [
          (editMode || form.superpowers) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { white: true, children: "Superpowers" }),
            editMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "superpowers", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { children: "Your Skills & Powers" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "superpowers",
              ...
              "p",
              {
                ...
                "data-ocid": "profile.superpowers_input",
                children: form.superpowers
              }
            )
          ] }),
          (editMode || interests) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex-1 min-w-0",
              "data-ocid": "profile.interests_section",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { white: true, children: "Interests" }),
                editMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "interests", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FieldLabel, { children: "What You Care About" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Textarea,
                    {
                      id: "interests",
    ...
    showCreateTribe && /* @__PURE__ */ jsxRuntimeExports.jsx(CreateTribeModal, { onClose: () => setShowCreateTribe(false) }),
    editingTribe && /* @__PURE__ */ jsxRuntimeExports.jsx(
      EditTribeModal,
      {
        tribe: editingTribe,
    ...
    transferTribe && /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    leavingTribe && /* @__PURE__ */ jsxRuntimeExports.jsx(
      LeaveTribeDialog,
      {
        tribe: leavingTribe,
        ...
        onConfirm: async () => {
          try {
            ...
            ue.error("Failed to leave tribe", {
              description: err instanceof Error ? err.message : "Unknown error"
            });
          } finally {
...
function TribeCard({
  ...
  const leaderboardEntry = tribeLeaderboard == null ? void 0 : tribeLeaderboard.find(
    (entry) => entry.tribeId === tribe.id
  );
  const rank = (leaderboardEntry == null ? void 0 : leaderboardEntry.rank) ?? 0;
  const score = (leaderboardEntry == null ? void 0 : leaderboardEntry.score) ?? 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        tribe.coverImageUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-24 overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                ...
                children: tribe.photoUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: tribe.photoUrl,
                    alt: tribe.name,
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-6 w-6 text-muted-foreground" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mt-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-accent text-sm uppercase tracking-widest text-white", children: "Members" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-foreground", children: tribe.memberCount.toString() })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-accent text-sm uppercase tracking-widest text-white", children: "Rank" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-foreground", children: rank > 0 ? `#${rank}` : "—" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-accent text-sm uppercase tracking-widest text-white", children: "Score" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-foreground", children: score > 0 ? score.toFixed(2) : "—" })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 pt-1 border-t border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "h-3 w-3 text-accent" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Copied!" })
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            isMine && onLeave && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: onLeave,
                ...
                children: leaveLoading ? "Leaving…" : "Leave Tribe"
              }
            ),
            isOwned && onEdit && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: onEdit,
            ...
            isOwned && onTransfer && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: onTransfer,
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-6 w-6 text-destructive flex-shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl text-destructive tracking-widest uppercase", children: "Caution!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-sm text-foreground leading-relaxed", children: [
                  "The stats accrued to",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-mono", children: tribe.name }),
                  " will remain there when you leave."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-sm text-muted-foreground", children: "Sure you want to leave?" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: pending ? "Leaving…" : "Leave Tribe"
                }
              )
            ] })
          ]
...
function TribesSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between border-b border-border pb-1 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-xl text-white tracking-widest uppercase flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-6 w-6" }),
          " Tribes"
        ] }) }),
        myTribe && /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-sm uppercase tracking-widest text-white mt-4 mb-2", children: "MY TRIBE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: tribeLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
          ...
          TribeCard,
          {
            ...
            onEdit: ownedTribes.some((t) => t.id === myTribe.id) ? () => onEditTribe(myTribe) : void 0,
            onTransfer: ownedTribes.some((t) => t.id === myTribe.id) ? () => onTransferTribe(myTribe) : void 0
          }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            searchFetching && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-3 top-1/2 -translate-y-1/2 font-accent text-sm text-accent animate-pulse", children: "SEARCHING…" })
          ] }),
          tribeSearch.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "tribe.search_results", children: tribeResults.length === 0 && !searchFetching ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", "data-ocid": "tribe.empty_state", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-xs text-muted-foreground", children: [
              'No tribes found for "',
              tribeSearch,
              '".'
            ] }),
            canCreateTribe && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
          ...
          ] }) : tribeResults.map((t, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 flex-shrink-0 pixel-border overflow-hidden bg-muted flex items-center justify-center", children: t.photoUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: t.photoUrl,
                      alt: t.name,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl text-accent tracking-widest truncate", children: t.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-xs text-muted-foreground", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: joiningId === t.id ? "Joining…" : "Join"
                    }
                  )
                ] })
              ]
        ...
        ownedTribes.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        !canCreateTribe && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground", children: "You've reached the maximum of 3 tribes." })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-accent text-sm uppercase tracking-widest text-white", children: [
            "Manage Tribes (",
            ownedTribes.length,
            "/3)"
          ] }),
          open ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4 text-accent" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-3 space-y-3", children: ownedTribes.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          TribeCard,
          {
            tribe: t,
            isOwned: true,
            isMine: (myTribe == null ? void 0 : myTribe.id) === t.id,
            onLeave: (myTribe == null ? void 0 : myTribe.id) === t.id ? () => onLeaveTribe(t) : void 0,
