const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BCGzjtT5.js","assets/index-D3Low12Q.js","assets/index-kPqGAi2-.css"])))=>i.map(i=>d[i]);
import { dH as getAugmentedNamespace, jI as bases, dG as commonjsGlobal, jJ as safeJsonParse, jK as safeJsonStringify, jL as cjs, jM as getWindowMetadata_1, jN as getDocument_1, jO as getNavigator_1, jP as C$3, jQ as detect, jR as getLocation_1, dJ as getDefaultExportFromCjs, jS as IEvents, dI as eventsExports, jT as isWsUrl, jU as cjs$1, jV as isLocalhostUrl, jW as formatJsonRpcError, jX as parseConnectionError, jY as i$1, jZ as h$2, j_ as isJsonRpcError, j$ as formatJsonRpcRequest, k0 as r$2, k1 as getBigIntRpcId, k2 as o, k3 as isJsonRpcRequest, k4 as isJsonRpcResponse, k5 as formatJsonRpcResult, k6 as Gg, k7 as isJsonRpcResult, k8 as payloadId, k9 as f$4, aR as __vitePreload } from "./index-D3Low12Q.js";
var queryString = {};
...
class C2 {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? m2(this.rpc.chains) : m2(this.rpc.optionalChains), this.signer = await Iv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s2;
      try {
        const { WalletConnectModal: i2 } = await __vitePreload(() => import("./index-BCGzjtT5.js").then((n2) => n2.i), true ? __vite__mapDeps([0,1,2]) : void 0);
        s2 = i2;
      } catch {
