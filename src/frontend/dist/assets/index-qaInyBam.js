const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CCG0ya53.js","assets/index-BwZJ_MxZ.js","assets/index-DqUaPUte.js","assets/index-kPqGAi2-.css","assets/parseSignature-BNDUQgjW.js","assets/index-DAkz1uIM.js","assets/index-uDUdl0BT.js","assets/index-Kl7qdtes.js","assets/index-BO22OfW2.js","assets/index-_SaNUVTM.js","assets/compat-CF_6u_h6.js","assets/ccip-Ct_2ILly.js","assets/index.es-DNf2ZkAL.js"])))=>i.map(i=>d[i]);
import { bs as createConnector, bt as custom, bu as getAddress, bv as SwitchChainError, bw as ChainNotConfiguredError, bx as numberToHex, by as fromHex, bz as ConnectorNotConnectedError, bA as UserRejectedRequestError, bB as RpcRequestError, bC as keccak256, bD as stringToHex, bE as withRetry, aR as __vitePreload, aN as withTimeout, bF as ResourceUnavailableRpcError, bG as ProviderNotFoundError } from "./index-DqUaPUte.js";
import { bH } from "./index-DqUaPUte.js";
import { r as rpc } from "./compat-CF_6u_h6.js";
mock.type = "mock";
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return __vitePreload(() => import("./index-CCG0ya53.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0);
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return __vitePreload(() => import("./index-DAkz1uIM.js"), true ? __vite__mapDeps([5,1,2,3,4]) : void 0);
          } catch {
    ...
    async getProvider() {
      ...
      if (!provider_) {
        const { default: SDK } = await (() => {
          try {
            return __vitePreload(() => import("./index-uDUdl0BT.js"), true ? __vite__mapDeps([6,7,2,3]) : void 0);
          } catch {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return __vitePreload(() => import("./index-BO22OfW2.js").then((n) => n.i), true ? __vite__mapDeps([8,2,3,7,9,4,10,11]) : void 0);
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return __vitePreload(() => import("./index.es-DNf2ZkAL.js"), true ? __vite__mapDeps([12,2,3]) : void 0);
          } catch {
