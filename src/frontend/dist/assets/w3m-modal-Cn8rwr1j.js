import{bk as k,dE as le,ag as c,ai as pe,a2 as v,a3 as V,a6 as f,a7 as g,a8 as d,a5 as l,aX as $,ar as H,aY as u,a4 as me,an as w,aa as B,aV as U,dd as fe,bq as F,ak as K,bh as A,av as M,ad as we,ah as E,bm as z,da as oe,aW as be,ac as ce,dF as ge,dG as ye}from"./index-CBVhFjWG.js";import{P as D}from"./index-or5eAuvZ.js";import{S as ve}from"./SwapController-A6FP9gal.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
